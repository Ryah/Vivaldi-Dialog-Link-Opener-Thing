(function () {
            ...
            chrome.windows.getLastFocused(function (window) {
                if (window.id === vivaldiWindowId && window.state !== 'minimized') {
                    if (itemInfo.menuItemId === "dialog-tab-link") {
                        ...
                        var engineId = "https://www.google.com/search?q=%s";
    ...
    function dialogTabSearch(engineId, selectionText) {
        var engineId = "https://www.google.com/search?q=";
        var searchText = engineId + selectionText;
        dialogTab(searchText);
    }
